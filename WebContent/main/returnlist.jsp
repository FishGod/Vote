...
<body>
	...
	<c:forEach items="${voInfors}" var="v">
		<tr>
			<td style="width:800px;padding-bottom:8px;border-bottom: 1px solid #E9E9E9;">
					...
					<a href="VoteServlet?flag=checkvote&vid=${v.voteId}&voteType=${v.voteType}">${v.voteName}</a>
					<div style="font-size:10px;margin-top:5px;padding-left:20px;">别看了，快投票啊！
						<a style="float: right;font-weight: normal;" href="VoteServlet?flag=join&vid=${v.voteId}&voteName=${v.voteName}&voteType=${v.voteType}">我要参与</a>
	...
	<center style="margin-top:30px;font-size: 12px">
		<a href="UserServlet?flag=page&gopage=${nowpage-1}">上一页</a>&nbsp;&nbsp;${nowpage}/${totalpage}&nbsp;
		<a href="UserServlet?flag=page&gopage=${nowpage+1}">下一页</a>
	</center>
</body>
